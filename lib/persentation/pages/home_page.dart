        ...
        builder: (context, contrains) {
          return Column(
            ...
            children: [
              ...
              SizedBox(height: 5),
              Text(
                """Portal ini bercerita tentang bangunan tua yang hidup kembali sebagai panggung, restoran, dan ruang publik. Dengan pendekatan Historic Urban Landscape (HUL), sejarah tetap hadir di tengah ritme kota hari ini.""",
                style: GoogleFonts.robotoFlex(
                  color: Colors.white,
                  fontSize: 16,
