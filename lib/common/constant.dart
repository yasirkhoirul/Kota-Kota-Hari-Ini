class Images {
  ...
  static const String circleright = "$basepath/iconbacktopright.svg";
  static List<String> svgAssets = [cricleback, circleright];
  static List<String> pngImage = [siluetbackground];
}
